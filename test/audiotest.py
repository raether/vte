...
##        self.lastRotate     = datetime.datetime.now().minute
    ...
    def propertyInput(self, argv):
        ...
        try:
            opts, args = getopt.getopt(self.args, "ha:f:qd",
                                       ["help", "framerate=", "audiodelay=", "quiet", "debug"])
        ...
        for opt, arg in opts:
            if opt == '-h':
                ...
                print('    -f    --framerate    set framerate')
                ...
                self.frameRate = arg
                print("set framerate to ", self.frameRate)
            
            elif opt in ("-a", "--audiodelay"):
                self.audioDelay = arg
                print("set audiodelay to ", self.audioDelay)
